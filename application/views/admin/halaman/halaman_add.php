  ...
  <div class='row'>
    <div class='col-sm-9'>
      ...
      <div class='form-group'>
        ...
        <input placeholder='Judul Halaman' value='<?php echo set_value('title'); ?>' type='text' name='title' required class='form-control' maxlength="150"/>
      </div>
      <div class='form-group'>
        <label>Konten</label>
        <textarea class='tinyMCE form-control' name='description' placeholder='Konten'><?php echo set_value('description'); ?></textarea>
    ...
    <div class='col-sm-3'>
      <div class='form-group'>
        ...
        <input placeholder="Judul Singkat" value='<?php echo set_value('short_title'); ?>' type='text' name='short_title' class='form-control' maxlength="100"/>
      </div>
      <div class='form-group'>
